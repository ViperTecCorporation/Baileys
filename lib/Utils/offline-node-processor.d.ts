 ...
 */
export declare function makeOfflineNodeProcessor(nodeProcessorMap: Map<OfflineNodeType, (node: BinaryNode) => Promise<void>>, deps: OfflineNodeProcessorDeps, batchSize?: number): {
    enqueue: (type: OfflineNodeType, node: BinaryNode) => void;
};
