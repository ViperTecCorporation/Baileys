...
const shouldIncludeReportingBase = (message) => !message.reactionMessage &&
    !message.encReactionMessage &&
    !message.encEventResponseMessage &&
    !message.pollUpdateMessage;
export const shouldIncludeReportingSecret = (message) => shouldIncludeReportingBase(message);
export const shouldIncludeReportingToken = (message) => shouldIncludeReportingBase(message);
